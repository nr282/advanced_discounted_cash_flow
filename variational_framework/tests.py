...
class TestVariationalFramework(unittest.TestCase):
    ...
    def test_daily_cash_flow_cash_flow(self):

        # Create a PeriodIndex starting from the first quarter of 2025 through four quarters
        quarters = pd.period_range(start="2025Q1", periods=15, freq="Q-DEC")
